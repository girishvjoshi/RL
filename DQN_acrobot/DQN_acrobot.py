...
file_name = 'Results_DQN_acrobot_test6'
...
class DQN(object):
    ...
    def __init__(self,sess,learning_rate, buffer_size):
        ...
        # State and action dimension is hardcoded make changes in Acrobot environment to ouput these values through command line.
        self.state_dim = 6
        self.action_dim = 3
    ...
    def createDQN(self, primary_net):
        ...
        if primary_net:
            #Save File
            self.save_file = "DQN_Results/acrobotDQN_net_test6"
            #Network Save
    ...
    with tf.Session() as sess:
        ...
        for epochs in range(MAX_EPOCH):
            ...
            for step in range(MAX_LENGTH):
                ...
                s2,r,done = agent.env.step(action)
